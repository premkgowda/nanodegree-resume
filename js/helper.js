...
*/
var HTMLheaderName = "<h1 id='name' class= 'text-cursive'>%data%</h1>";
var HTMLheaderRole = "<span class='text-uppercase'>%data%</span><hr>";
...
var HTMLskillsStart = "<h3 id='skillsH3' class= 'text-cursive'>Skills at a Glance:</h3><ul id='skills' class='flex-box'></ul>";
